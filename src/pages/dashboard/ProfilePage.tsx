      ...
      <div className="p-6 sm:p-8 bg-white rounded-2xl border border-slate-200 shadow-xs space-y-6">
        <div className="flex flex-col sm:flex-row items-center gap-5 pb-6 border-b border-slate-100">
          <img
            ...
            className="w-20 h-20 rounded-full object-cover border-2 border-amber-400/60 shadow-sm"
          />
          <div className="text-center sm:text-left space-y-1">
            <h2 className="font-display font-bold text-xl text-slate-900">{currentUser.name}</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
          ...
          <div className="p-4 bg-slate-50 rounded-xl border border-slate-200/80">
            <span className="text-slate-400 block mb-1">Status Langganan:</span>
            <span className="text-emerald-700 font-semibold flex items-center gap-1">
              <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" />
              Gratis Selamanya (MVP)
            </span>
          </div>
        </div>
